...
async def test_zero_information_leakage_unapproved_config() -> None:
    ...
    async def test_callback(session: ClientSession) -> None:
        ...
        config_result = await session.call_tool(name="context-protector-block", arguments={})
        ...
        blocked_result = await session.call_tool(name="test_tool", arguments={"message": "test"})
        ...
        nonexistent_result = await session.call_tool(
            name="nonexistent_totally_fake_tool", arguments={}
        )
...
async def test_information_visible_after_approval() -> None:
    ...
    async def test_callback(session: ClientSession) -> None:
        ...
        result = await session.call_tool(
            name="test_tool", arguments={"message": "Hello after approval!"}
        )
