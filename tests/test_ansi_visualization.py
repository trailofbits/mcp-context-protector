...
async def run_with_ansi_visualization(callback: Callable[[ClientSession], Awaitable[None]], 
                               config_path: str, visualize_ansi: bool = False):
    """
...
class TestAnsiVisualization:
    ...
    async def test_ansi_passthrough_default(self):
        ...
        await run_with_ansi_visualization(callback, self.config_path, visualize_ansi=False)
    ...
    async def test_ansi_visualization_enabled(self):
        ...
        await run_with_ansi_visualization(callback, self.config_path, visualize_ansi=True)