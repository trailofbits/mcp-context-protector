...
async def test_tool_modification_granular_blocking():
    ...
    tool1 = MCPToolDefinition(
        ...
        parameters=[
            MCPParameterDefinition(name="param1", description="Param 1", type=ParameterType.STRING, required=True)
        ]
    )
    tool2 = MCPToolDefinition(
        ...
        parameters=[
            MCPParameterDefinition(name="param2", description="Param 2", type=ParameterType.STRING, required=True)
        ]
    )
    ...
    approval_status = db.get_server_approval_status("stdio", "test_multi_tool_server", modified_config)
...
async def test_server_instructions_change_blocks_everything():
    ...
    tool = MCPToolDefinition(
        ...
        parameters=[
            MCPParameterDefinition(name="param", description="Test param", type=ParameterType.STRING, required=True)
        ]
    )
    ...
    approval_status = db.get_server_approval_status("stdio", "test_instruction_server", modified_config)
    ...
    assert db.are_instructions_approved("stdio", "test_instruction_server", modified_config.instructions) == False
...
async def test_mixed_approval_states():
    ...
    assert db.is_tool_approved("stdio", "test_mixed_server", "unapproved_tool", unapproved_tool) == False
...
async def test_tool_parameter_modification_blocking():
    ...
    original_tool = MCPToolDefinition(
        ...
        parameters=[
            MCPParameterDefinition(name="param1", description="Original param", type=ParameterType.STRING, required=True)
        ]
    )
    ...
    modified_tool = MCPToolDefinition(
        ...
        parameters=[
            MCPParameterDefinition(name="param1", description="MODIFIED param", type=ParameterType.STRING, required=True)
        ]
    )
    ...
    assert db.is_tool_approved("stdio", "param_test_server", "param_test_tool", original_tool) == True
    assert db.is_tool_approved("stdio", "param_test_server", "param_test_tool", modified_tool) == False